<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item label="是否可用Y可用N不可用" prop="availableFlag">
        <el-select v-model="queryParams.availableFlag" placeholder="请选择是否可用Y可用N不可用" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['baseconfig:industry:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" border :data="industryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否可用Y可用N不可用" align="center" prop="availableFlag">
        <template slot-scope="scope">
      ...
      <el-table-column label="行业介绍" align="center" prop="introduction" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否可用Y可用N不可用">
