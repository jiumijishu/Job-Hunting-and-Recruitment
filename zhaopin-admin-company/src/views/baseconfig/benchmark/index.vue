    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['baseconfig:benchmark:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listBenchmark, getBenchmark, delBenchmark, addBenchmark, updateBenchmark } from "@/api/baseconfig/benchmark";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除标杆企业编号为"' + ids + '"的数据项？').then(function() {
