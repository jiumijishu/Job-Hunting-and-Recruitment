<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['baseconfig:project:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['baseconfig:project:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['baseconfig:project:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['baseconfig:project:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" border :data="projectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="公司名称" align="center" prop="projectName" />
      <el-table-column label="开始时间" align="center" prop="startDate" />
      <el-table-column label="结束时间" align="center" prop="endDate" />
      <el-table-column label="项目描述" align="center" prop="projectContent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="公司名称" prop="projectName">
          <el-input v-model="form.projectName" placeholder="请输入公司名称" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startDate">
...
<script>
import { listProject, getProject, delProject, addProject, updateProject } from "@/api/baseconfig/project";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除项目经验编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('baseconfig/project/export', {
        ...this.queryParams
