<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item label="职位名称" prop="typeName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['baseconfig:jobsort:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" border :data="jobsortList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="职位名称" align="center" prop="typeName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="职位名称" prop="typeName">
          <el-input v-model="form.typeName" placeholder="请输入职位名称" />
        </el-form-item>
        ...
        <el-form-item label="职位介绍" prop="details">
  ...
  methods: {
    ...
    getList() {
      ...
      listJobsort(this.queryParams).then(response => {
        this.jobsortList = response.rows;
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除职位分类1编号为"' + ids + '"的数据项？').then(function() {
        return delJobsort(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('baseconfig/jobsort/export', {
        ...this.queryParams
      }, `jobsort_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
