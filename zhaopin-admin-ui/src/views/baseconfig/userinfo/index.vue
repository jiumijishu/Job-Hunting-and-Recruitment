<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="companyaccontList">
      ...
      <el-table-column label="毕业学校" align="center" prop="schoolName" />
      ...
      <el-table-column label="最近登陆时间" align="center" prop="loginDate" >
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <router-link
            v-if="scope.row.resumeId"
            :to="'/users/userdetail?id=' +scope.row.resumeId"
          >
            <el-button
              size="mini"
              type="text"
          ...
          >{{scope.row.referrerFlag==='Y'?'取消推荐简历':'推荐简历'}}</el-button>
...
import {listWXUser} from "@/api/system/user";
import {updateResume} from "@/api/baseconfig/resume";

export default {
  name: "userinfo",
  dicts: ['sys_yes_no','sys_education'],
  data() {
    return {
      // 遮罩层
      loading: true,
