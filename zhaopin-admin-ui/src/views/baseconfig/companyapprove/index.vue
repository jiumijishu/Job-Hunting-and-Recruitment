<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="companyList" >
      ...
      <el-table-column label="驳回原因" align="center" prop="auditRemark" v-if="activeName==='second'"/>
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <router-link
            :to="'/approve/companyapprovedetail?id=' +scope.row.id"
          >
            <el-button
              size="mini"
              type="text"
...
export default {
  ...
  created() {
    this.queryParams.auditStatus='01';
    this.getList();
  },
  methods: {
    /** 查询待审核公司列表 */
    ...
    handleClick(event){
      if(this.activeName==='second'){
        this.queryParams.auditStatus='03';
      }else{
        this.queryParams.auditStatus='01';
      }
      this.getList();
