<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="feedbackList">
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="反馈类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择反馈类型" disabled>
            <el-option
              v-for="dict in dict.type.sys_feedback_type"
              :key="dict.value"
              :label="dict.label"
:value="dict.value"
        ...
        <el-form-item label="反馈图片">
          <el-image :src="form.imageUrl" style="width:200px"></el-image>
        </el-form-item>
