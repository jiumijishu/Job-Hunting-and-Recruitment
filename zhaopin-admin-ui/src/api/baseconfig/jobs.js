...
export function listJobsAll(query) {
  return request({
    url: '/baseconfig/jobs/queryAllJobList',
    method: 'get',
    params: query
  })
}

export function listJobsApproveData(query) {
  return request({
    url: '/baseconfig/jobs/queryAllApproveJobList',
    method: 'get',
    params: query
  })
}
